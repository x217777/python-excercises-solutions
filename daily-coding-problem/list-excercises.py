...
product_of_array_except_current_index([3, 2, 1])
product_of_array_except_current_index([1, 2, 3, 4, 5])
product_of_array_except_current_index([1, 1, 1])
product_of_array_except_current_index([1, 0, 0])
product_of_array_except_current_index([0, 0, 0])
